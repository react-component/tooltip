...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__src_placements__ = __webpack_require__(92);
...
var Test = function (_Component) {
    ...
    function Test() {
        ...
        _this.state = {
            ...
            placement: 'right',
            offsetX: __WEBPACK_IMPORTED_MODULE_8__src_placements__["a" /* default */].right.offset[0],
            offsetY: __WEBPACK_IMPORTED_MODULE_8__src_placements__["a" /* default */].right.offset[1],
            transitionName: ''
        };
        _this.onPlacementChange = function (e) {
            var placement = e.target.value;
            var offset = __WEBPACK_IMPORTED_MODULE_8__src_placements__["a" /* default */][placement].offset;
            _this.setState({
                ...
                __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
                            ...
                            Object.keys(__WEBPACK_IMPORTED_MODULE_8__src_placements__["a" /* default */]).map(function (p) {
                                return __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
                                    'option',
                                    { key: p, value: p },
                                    p
                    ...
                    __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
                        'label',
                        null,
                        __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('input', { value: 'rmc-tooltip-zoom', type: 'checkbox', onChange: this.onTransitionChange, checked: this.state.transitionName === 'rmc-tooltip-zoom' }),
                        'transitionName'
                    ),
                    '\xA0\xA0\xA0\xA0',
                    __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
                        'label',
                        null,
                        __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('input', { type: 'checkbox', onChange: this.onDestroyCheck, checked: this.state.destroyTooltipOnHide }),
                    ...
                    __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
                        ...
                        null,
                        'offsetX:',
                        __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('input', { type: 'text', value: state.offsetX, onChange: this.onOffsetXChange, style: { width: 50 } })
                    ),
                    '\xA0\xA0\xA0\xA0',
                    __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
                        'label',
                        null,
                        'offsetY:',
                        __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement('input', { type: 'text', value: state.offsetY, onChange: this.onOffsetYChange, style: { width: 50 } })
                    )
                ),
                __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
                    'div',
                    ...
                    __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
                        ...
                        { placement: this.state.placement, destroyTooltipOnHide: this.state.destroyTooltipOnHide, onVisibleChange: this.onVisibleChange, overlay: __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
                                'div',
